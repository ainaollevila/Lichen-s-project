...
addpath(g);
%%
string = sprintf('/Users/aina/Dropbox/Lichen-s-project/data/cooc_mat/mat_fulldataset.csv')
string
...
bp = Bipartite(A);
%%
string2 = sprintf('/Users/aina/Dropbox/Lichen-s-project/data/cooc_mat/Results/fulldataset_genprop.txt')
diary(string2)
...
string_fig1 = sprintf('/Users/aina/Dropbox/Lichen-s-project/data/cooc_mat/Results/fulldataset_fig1.pdf')
figure(1);
...
figure(2);
string_fig2 = sprintf('/Users/aina/Dropbox/Lichen-s-project/data/cooc_mat/Results/fulldataset_fig2.pdf')
...
figure(3);
string_fig3 = sprintf('/Users/aina/Dropbox/Lichen-s-project/data/cooc_mat/Results/fulldataset_fig3.pdf')
...
figure(4);
string_fig4 = sprintf('/Users/aina/Dropbox/Lichen-s-project/data/cooc_mat/Results/fulldataset_fig4.pdf')
...
string_fig6 = sprintf('/Users/aina/Dropbox/Lichen-s-project/data/cooc_mat/Results/fulldataset_fig6.pdf')
